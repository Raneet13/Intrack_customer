...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
        ...
        child: SafeArea(
          child: Stack(
            children: [
              ...
              _buildAnimatedPin(null, 150, 80, null, 1000, AppTheme.accentOrange),
        ...
        Stack(
          ...
          children: [
            Container(
              ...
              child: Image.asset("assets/intrack_logo.png", width:48, height: 48,)
            ),
            Positioned(
              top: -4,
              right: -4,
  ...
  Widget _buildFooterFeatures() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Expanded(child: _buildFeature('24/7', 'Real-Time Tracking', Colors.blue.shade200)),
        Container(
          width: 1,
          height: 40,
        ...
        Expanded(child: _buildFeature('GPS', 'Accurate Location', Colors.green.shade200)),
        Container(
          width: 1,
          height: 40,
          margin: const EdgeInsets.symmetric(horizontal: 16),
        ...
        Expanded(child: _buildFeature('100%', 'Secure Platform', Colors.orange.shade200)),
      ],
    );
  }
